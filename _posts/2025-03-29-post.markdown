...
```
The complete code is [here](https://github.com/Julien5/sandbox/blob/master/test/rust/minesweeper/src/baseline.rs). I couldn't resist making the output more readable by using '|' as separators, even if that is a bit slower:
```

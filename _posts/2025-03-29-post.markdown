...
I'm not sure why this is happening, and it's a bit unsettling. I fear there might be an error in the code, but I haven't been able to identify it. If you spot any issues, please feel free to email me. Perhaps the Rust compiler is simply working harder to optimize, which could explain the increased compilation time. Honestly, I don't know.

At this point I could call it a day and move on, but I was caught and wanted to make my minesweeper code faster with multithreading. [Fearless Concurrency](https://doc.rust-lang.org/book/ch16-00-concurrency.html) is a big selling point of rust. 

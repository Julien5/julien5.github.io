...
```
I could not help to make the output more readable with "|" as separators:
```
...
When the tiles are merged together for printing, we must take properly care of those edges. This resulting algorithm is as follows:

...
Because of this, and because we want to parallelize, it makes sense to add "margins" to our grid, which gets length $$(N+2)x(N+2)$$. 
...
![K]({{site.url}}/assets/minesweeper/time-chunks.png)
![L]({{site.url}}/assets/minesweeper/time-array-2.png)
![L]({{site.url}}/assets/minesweeper/time-array-8.png)
